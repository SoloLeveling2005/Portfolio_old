...
function Dialogue(props:{'title':string, 'img_url':string, 'id':string, 'onClick':any, 'parentGetMessages':any }) {
    let title = props.title
    let id = props.id
    let img_url = props.img_url
    let parentGetMessages = props.parentGetMessages
